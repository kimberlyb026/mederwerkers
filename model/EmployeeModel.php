...
function createEmployee($data){
    ...
    $conn = openDataBaseConnection();
        $insert = $conn->prepare("INSERT  INTO `employees` (`id`, `name`, `age`) VALUES (:id, :name, :age)");
 ...
 function updateEmployee($data){
    ...
    $conn = openDataBaseConnection();
    $stnt = $conn->prepare("UPDATE `employees` SET id = :id, name = :name, age=:age WHERE id = :id");
    $stnt->bindParam(':id', $data);
    $stnt->bindParam(':name', $data);
    $stnt->bindParam(':age', $data);
